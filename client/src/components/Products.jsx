    ...
    return (
        <div>
            {loading ? (<h1>loading</h1>) : error ? (<h1>{error}</h1>) : (
                <>
                    <section id="catalog" className="text-gray-600 body-font">
                        <div className="container px-5 py-0 mx-auto">
                            <div className="flex justify-center pt-8">                        
                                <h2 className=" title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Nuestros Productos</h2>
                            </div>
                            <div className="flex flex-wrap -m-4">
                                ...
                                {products.map((product)=>(
                                    ...
                                    <div className="bg-white">
                                        <div className="max-w-2xl px-4 py-14 sm:px-6 sm:py-16 lg:max-w-7xl lg:px-8">
