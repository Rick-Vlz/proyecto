                ...
                <div className="gap-4 sm:flex sm:items-center sm:justify-between">
                  ...
                  <div className="mt-6 gap-4 space-y-4 sm:mt-0 sm:flex sm:items-center sm:justify-end sm:space-y-0">
                    <div>
                      ...
                      >
                        <option selected>Todas las ordenes</option>
                        <option value="pre-order">Pre-ordenes</option>
                        <option value="transit">En espera</option>
                      ...
                      orders.map((order) => (
                        ...
                        >
                          ...
                          <dl className="w-1/2 sm:w-1/4 lg:w-auto lg:flex-1 ml-10">
                            ...
                            <dd className="mt-1.5 text-base font-semibold text-gray-900 dark:text-white">
                              {moment(order.createdAt).format('D MM YYYY, h:mm')}
                            </dd>
                          </dl>
